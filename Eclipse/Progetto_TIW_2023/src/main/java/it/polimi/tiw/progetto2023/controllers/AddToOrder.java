			...
			try {
				...
				try {
					...
					try {
						...
						resp.sendError(HttpServletResponse.SC_BAD_REQUEST, "The specified house number is not a number.");
						return;
					}
				...
				resp.sendError(HttpServletResponse.SC_BAD_REQUEST, "The specified ID is not a number.");
				return;
			}
